  ...
  return (
    ...
    >
      ...
      >
        <aside
          className={cn(
            "hidden lg:block lg:w-[25%] xl:w-[20%] rounded-lg shadow-[1px_1px_10px_2px] shadow-white/10 border border-gray-700"
          )}
        >
          <SideMenu />
        </aside>
        <aside
          className={cn(
            "w-full lg:w-[75%] xl:w-[80%] rounded-lg shadow-[1px_1px_10px_2px] shadow-white/10 border border-gray-700"
          )}
        >
